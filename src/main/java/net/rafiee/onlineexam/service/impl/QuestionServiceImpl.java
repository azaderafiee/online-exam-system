...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    public List<QuestionResponseDTO> getQuestionsByInstructorIdAndCourseCode(String username, String courseCode) {
        return questionRepository.findByCreatedByUsernameAndCourse_CourseCode(username, courseCode).stream()
                .map(this::mapToQuestionResponseDTO)
                .collect(Collectors.toList());
    }
